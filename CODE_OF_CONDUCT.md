...
the `ToolSicurezza` community a harassment-free experience for everyone,
...
- Suggesting, demonstrating, or advocating for the use of this software
  against systems for which the user is not authorised
- Other conduct which could reasonably be considered inappropriate in a
  professional setting

## Ethics-specific standards (project-specific)

Because this is a security tool, additional unacceptable behaviour
includes:

- Posting cleartext credentials extracted from someone else's machine,
  even as a "demonstration".
- Posting decryption help for credentials the requester does not own.
- Asking maintainers to bypass authentication systems for which the
  requester has not produced authorisation.
- Sharing weaponised samples, exploit kits, or operational malware in
  issues, PRs, or discussions.

When in doubt, ask. The maintainers will close any discussion that
appears to be approaching unauthorised use, and may permanently ban
participants who do so repeatedly.
...
be reported to the maintainers responsible for enforcement, via the
contact channel in [SECURITY.md](SECURITY.md). All complaints will be
...
individuals. **Or:** demonstrably using the software, or encouraging
others to use it, against systems the user does not own and is not
authorised to test.
...
2.1, with project-specific additions for security-tool ethics.
